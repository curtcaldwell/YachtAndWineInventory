...
namespace Inventory.Models
{
  ...
  //       string itemWine = rdr.GetString(2);
  ...
  //
  //     var cmd = conn.CreateCommand() as MySqlCommand;
  //     cmd.CommandText = @"INSERT INTO `Inventory` (`wine`) VALUES (@itemWine);";
  //
  ...
  public class Yacht
  {
    ...
    public void Save()
    {
      ...
      var cmd = conn.CreateCommand() as MySqlCommand;
      cmd.CommandText = @"INSERT INTO `Inventory` (`yacht`, `wine`) VALUES (@itemYacht);";
